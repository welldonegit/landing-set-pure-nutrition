...
export const RULES = {
  ...
  // Доставку (місто + відділення/поштомат/адреса) валідуємо окремо:
  // це структурований об'єкт, а не рядок. Див. delivery-validation.js
  // на сервері та features/delivery.js у браузері.
};
